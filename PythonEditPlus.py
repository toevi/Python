...
class PythonEditor:
    ...
    def create_widgets(self):
        ...
        self.line_numbers = tk.Text(
            ...
            font=("Consolas", 12)  # ta sama czcionka i rozmiar co edytor
        )
    ...
    def on_line_numbers_scroll(self, *args):
    ...
    def bind_events(self):
        ...
        # Usuwam blokowanie klawiszy strzałek, by nie zawieszało edytora
    ...
    def on_click(self, event):
        ...
        self.highlight_current_line()
        # Usunięto return "break" aby umożliwić edycję w miejscu kliknięcia
